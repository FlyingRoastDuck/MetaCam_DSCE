...
from reid.models.em import CamMemory
from reid.trainers import CamTrainer, Trainer_USL
...
from reid.utils.tools import get_test_loader, get_train_loader, get_plot_loader
...
def main_worker(args):
    ...
    memory = CamMemory(2048, len(dataset.train),
    ...
    for epoch in range(args.startE):
        ...
        va_trainer.train(epoch, train_loader, optimizer,
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="MetaCam with ACT Merge and Camera-Wloss")
    # data
